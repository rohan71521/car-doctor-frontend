                        ...
                        <form
                         ...
                         className="card-body">
                            ...
                            <div className="form-control">
                                ...
                                <label htmlFor='check' className=" flex gap-2 cursor-pointer">
                                    <input type="checkbox" id='check' name='check' />
                                    <p> please accept our terms and conditons</p>
                                </label>
                            </div>
                            <div className="form-control mt-6">
                                <button className="button primary-fill-button-2">Register</button>
                            </div>
                        </form>
                    </div>
